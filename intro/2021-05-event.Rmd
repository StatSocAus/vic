...
# Shutdowns and Slow-Downs: Detecting Anomalies in Granular Internet Activity Data, at Global Scale

.fr.pl2[
  .circle-image-200[
    <img src="images/simon-angus.png">]
]

Associate Prof. **Simon Angus**  
  Monash University
...
<br>
  ...
  Thanks to 
- **Lidija Turkovic** (Event Coordinator)
- **Rheanna Mainzer** (Deputy Event Coordinator)
