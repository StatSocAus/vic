...
.w-20[
`r person("", "Shuwen Hu", "Secretary")`
]
.w-20[
`r person("rick.jpg", "Rick Tankard", "Treasurer", twitter = "@RickTankard")`
]
.w-20[
`r person("", "Ninh Tran", "Membership Officer")`
]
.w-20[
`r person("", "Nicholas Tierney", "Communications Officer")`
]
.w-20[
...
.w-20[
`r person("", "Ryan Covey", "Deputy Secretary")`
]
.w-20[
...
.w-20[
`r person("", "Victorino Marquez Grajales", "Deputy Comms Officer")`
]

]

<!-- .center[ -->
<!-- **Tonight's event organiser is Elena** -->
<!-- ] -->
...
Location: In person in Melbourne. <br>
...
.f4[
Thanks to our Event Coordinator Jodi Phillips.
