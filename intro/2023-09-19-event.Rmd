...
[**jessica.kasza@monash.edu**](mailto:jessica.kasza@monash.edu)
...
- <i class="fas fa-calendar"></i> **Tuesday 14th October** <br><br> *Belz Lecture with Professor Inge Koch: Mathematics, Statistics and Gender* <br>
Registrations now open. <br>
Belz Dinner to follow: University House at the Woodward 

<br>

- <i class="fas fa-calendar"></i> **Tuesday 21st November** <br><br>*Panel discussion on the role of Statisticians in Society* <br>
More details on panelists and location to come. Save the date!
...
<img src="images/rheanna-mainzer.jpg">]
.circle-image-120.pb3[
<img src="images/ximena-camacho.jpg">]
.circle-image-120[
<img src="images/damian-pavlyshyn.png">]
]

.fr.pr3[
.circle-image-120.pb3[
<img src="images/floyd-everest.jpg">]
.circle-image-120[
<img src="images/naryman-tarvand.png">]
]
...
## Early Career and Student Statistician Showcase


**Floyd Everest** .f4[Monash University]

**Dr Rheanna Mainzer**  .f4[Murdoch Children's Research Institute]

**Naryman Tarvand** .f4[Biarri]

**Ximena Camacho** .f4[Univeristy of New South Wales]

**Dr Damian Pavlyshyn** .f4[Burnet Institute]

<br>

.f4[
Thanks to **Melissa Middleton** (Event Coordinator)
 and<br> **Ben Wee and Ben Harrap** (Deputy Event Coordinators)
