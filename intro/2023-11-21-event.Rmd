...
<img src="images/jenny-telford.jpg">]
.circle-image-120.pb3[
<img src="images/ian-gordon2.png">]
]

.fr.pr3[
.circle-image-120.pb3[
<img src="images/carolyn-huston.jpg">]
.circle-image-120[
...
## Panel Discussion: Statisticians in Society


**Dr Carolyn Huston** .f4[CSIRO]

**Jenny Telford**  .f4[Australian Bureau of Statistics]

**Alun Pope** .f4[Analytical Insight]

**Professor Ian Gordon** .f4[Statistical Consulting Centre/University of Melbourne]

<br>

.f4[
Thanks to **Alun Pope** (Event Coordinator)
 and<br> **Ben Harrap** (Deputy Event Coordinator)
