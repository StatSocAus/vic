...
`r person("damjan.jpeg", "Damjan Vukcevic")`
...
`r person("person.png", "Belinda Maher")`
`r person("person.png", "Joanne Potts")`
`r person("person.png", "Melissa Middleton")`
...
* This is a **open-source statistical software award**.
