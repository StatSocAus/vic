...
# 👏 Thank you to the SSA Vic Council 2022
...
# 👋 Welcome to the SSA Vic Council 2023
...
.w-20[
`r person("alun.png", "Alun Pope", "&nbsp;")`
]
.w-20[
`r person("anna.jpg", "Anna Wilkinson", "&nbsp;", twitter = "@AnnaLWil")`
]
.w-20[
`r person("ben-wee.jpg", "Benjamin Wee", "&nbsp;", twitter = "@BenwWee")`
]
.w-20[
...
* We offer funding support to our members! Details to come soon.
...
* We will announce the **winner** after the talk!
...
* Submissions close on **Fri Apr 22nd 2023**.
...
.circle-image-200.fr[
<img src="images/gordon-smyth.jpg">]

### **Professor Gordon Smyth**   

*Head of WEHI's Bioinformatics Division*   
