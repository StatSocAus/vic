...
[This repo](https://github.com/StatSocAus/vic) contains materials to host the intro HTML slides used in the events of the Victorian Branch of Statistical Society of Australia (SSA Vic). 
